...
public class DistanceUtils {
	protected static double euclidianDistanceOneDimension(double firstCharacteristic, double secondCharacteristic) {
		return Math.abs(firstCharacteristic-secondCharacteristic);
	}
